...
public class BaseConnectorConfig
    extends AbstractConfig {
  public static final BaseConnectorConfig.ConfigOptions DEFAULT_CONFIG_OPTIONS = new BaseConnectorConfig.ConfigOptionsImpl();
   ...
   */
  public BaseConnectorConfig(ConfigDef definition, Map<?, ?> originals) {
   ...
   * @param originals Original Configuration values as they were passed from the client.
   */
  public BaseConnectorConfig(Map<?, ?> originals) {
    this(BaseConnectorConfig.config(DEFAULT_CONFIG_OPTIONS), originals, false);
  }
   ...
   */
  public BaseConnectorConfig(ConfigDef definition, Map<?, ?> originals, boolean dolog) {
   ...
   */
  public static ConfigDef config(BaseConnectorConfig.ConfigOptions options) {
  ...
  static class ConfigOptionsImpl
      implements BaseConnectorConfig.ConfigOptions {
  }
}
