...
public class ExampleSourceConnectorConfig
    extends BaseConnectorConfig {
  public static final ExampleSourceConnectorConfig.ConfigOptions DEFAULT_CONFIG_OPTIONS = new ExampleSourceConnectorConfig.ConfigOptionsImpl();
   ...
   */
  public ExampleSourceConnectorConfig(ConfigDef definition, Map<?, ?> originals) {
   ...
   * @param originals Original Configuration values as they were passed from the client.
   */
  public ExampleSourceConnectorConfig(Map<?, ?> originals) {
    this(ExampleSourceConnectorConfig.config(DEFAULT_CONFIG_OPTIONS), originals, false);
  }
   ...
   */
  public ExampleSourceConnectorConfig(ConfigDef definition, Map<?, ?> originals, boolean dolog) {
   ...
   */
  public static ConfigDef config(ExampleSourceConnectorConfig.ConfigOptions options) {
  ...
  static class ConfigOptionsImpl
      implements ExampleSourceConnectorConfig.ConfigOptions {
  }
}
